...
const mockProjects: Project[] = [
  { id: 'p1', name: 'Project Alpha', createdAt: new Date(), updatedAt: new Date(), userId: 'u1', description: '' },
  { id: 'p2', name: 'Project Beta', createdAt: new Date(), updatedAt: new Date(), userId: 'u1', description: '' },
];
