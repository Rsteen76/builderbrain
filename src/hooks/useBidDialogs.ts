...
/**
 * Options for initializing the useBidDialogs hook
 */
export interface UseBidDialogsOptions {
...
/**
 * Hook for managing bid dialog state and operations
 * 
 * This hook extracts and centralizes dialog state management for bid-related dialogs,
 * particularly the bid form dialog used for creating and editing bids.
 */
export function useBidDialogs(userId: string | undefined, options: UseBidDialogsOptions = {}) {
